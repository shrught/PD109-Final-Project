...
{
    if (!font.loadFromFile("/Users/wangyanpu/Desktop/台灣大學/大二上/程設設計/期末報告/A-Cnake/resources/fonts/prstartk.ttf"))
    {
        // handle error
    }
    
    if (!bg_texture.loadFromFile("/Users/wangyanpu/Desktop/台灣大學/大二上/程設設計/期末報告/flighter/flighter/pdogs.png"))
    {
        // handle error
    }
